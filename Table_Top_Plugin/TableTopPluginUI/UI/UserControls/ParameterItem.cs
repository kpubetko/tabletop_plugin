...
namespace TableTopPluginUI.UI.UserControls
{
    ...
    public partial class ParameterItem : UserControl
    {
        ...
        /// </summary>
        /// <param name="sender">Источник события (не используется).</param>
        /// <param name="e">Данные события, позволяющие отменить закрытие контрола при некорректном вводе.</param>
        /// <remarks>
        ...
        /// <param name="e">Данные события (не используются).</param>
        /// <remarks>
        /// Проверяет введенное значение на соответствие числовому типу и
        /// диапазону допустимых значений параметра. При выходе за границы
        /// подсвечивает поле розовым цветом и отображает всплывающую подсказку
        ...
        /// <param name="e">Данные события (не используются).</param>
        /// <remarks>
        /// Проверяет текущее значение в поле ввода на соответствие обновленным
        /// границам параметра. При выходе за границы подсвечивает поле розовым
        /// цветом и отображает всплывающую подсказку с описанием ошибки.
