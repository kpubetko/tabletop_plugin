namespace TableTopPluginUI.UI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            parameterItem_Length = new UserControls.ParameterItem();
            parameterItem_Width = new UserControls.ParameterItem();
            parameterItem_Height = new UserControls.ParameterItem();
            parameterItem_CornerRadius = new UserControls.ParameterItem();
            parameterItem_ChamferRadius = new UserControls.ParameterItem();
            parameterItem_WaveRadius = new UserControls.ParameterItem();
            ...
            button_Build.Location = new Point(253, 145);
            button_Build.Margin = new Padding(2, 1, 2, 1);
            button_Build.Name = "button_Build";
            button_Build.Size = new Size(245, 23);
            ...
            progressBarMain.Location = new Point(253, 170);
            progressBarMain.Margin = new Padding(2, 1, 2, 1);
            progressBarMain.Name = "progressBarMain";
            progressBarMain.Size = new Size(245, 14);
            ...
            tableLayoutPanel1.Size = new Size(751, 194);
            tableLayoutPanel1.TabIndex = 0;
            // 
            // parameterItem_Length
            // 
            parameterItem_Length.Dock = DockStyle.Fill;
            parameterItem_Length.Location = new Point(1, 0);
            parameterItem_Length.Margin = new Padding(1, 0, 1, 0);
            parameterItem_Length.Name = "parameterItem_Length";
            parameterItem_Length.Size = new Size(749, 24);
            parameterItem_Length.TabIndex = 0;
            // 
            // parameterItem_Width
            // 
            parameterItem_Width.Dock = DockStyle.Fill;
            parameterItem_Width.Location = new Point(1, 24);
            parameterItem_Width.Margin = new Padding(1, 0, 1, 0);
            parameterItem_Width.Name = "parameterItem_Width";
            parameterItem_Width.Size = new Size(749, 24);
            parameterItem_Width.TabIndex = 1;
            // 
            // parameterItem_Height
            // 
            parameterItem_Height.Dock = DockStyle.Fill;
            parameterItem_Height.Location = new Point(1, 48);
            parameterItem_Height.Margin = new Padding(1, 0, 1, 0);
            parameterItem_Height.Name = "parameterItem_Height";
            parameterItem_Height.Size = new Size(749, 24);
            parameterItem_Height.TabIndex = 2;
            // 
            // parameterItem_CornerRadius
            // 
            parameterItem_CornerRadius.Dock = DockStyle.Fill;
            parameterItem_CornerRadius.Location = new Point(1, 72);
            parameterItem_CornerRadius.Margin = new Padding(1, 0, 1, 0);
            parameterItem_CornerRadius.Name = "parameterItem_CornerRadius";
            parameterItem_CornerRadius.Size = new Size(749, 24);
            parameterItem_CornerRadius.TabIndex = 3;
            // 
            // parameterItem_ChamferRadius
            // 
            parameterItem_ChamferRadius.Dock = DockStyle.Fill;
            parameterItem_ChamferRadius.Location = new Point(1, 96);
            parameterItem_ChamferRadius.Margin = new Padding(1, 0, 1, 0);
            parameterItem_ChamferRadius.Name = "parameterItem_ChamferRadius";
            parameterItem_ChamferRadius.Size = new Size(749, 24);
            parameterItem_ChamferRadius.TabIndex = 4;
            // 
            // parameterItem_WaveRadius
            // 
            parameterItem_WaveRadius.Dock = DockStyle.Fill;
            parameterItem_WaveRadius.Location = new Point(1, 120);
            parameterItem_WaveRadius.Margin = new Padding(1, 0, 1, 0);
            parameterItem_WaveRadius.Name = "parameterItem_WaveRadius";
            parameterItem_WaveRadius.Size = new Size(749, 24);
            ...
            ClientSize = new Size(751, 194);
            Controls.Add(tableLayoutPanel1);
            Margin = new Padding(2, 1, 2, 1);
            MaximumSize = new Size(767, 233);
            MinimumSize = new Size(767, 233);
            Name = "MainForm";
